(() => {
    ...
    let formValidate = {
        ...
        telTest(formRequiredItem) {
            return !/^\d{10}$/.test(formRequiredItem.value);
        }
    };
    ...
    function initSliders() {
        if (document.querySelector(".green-slider")) {
            var menu = [ "продажа", "закрепление", "ограничения" ];
            new core(".green-slider", {
                ...
                navigation: {
                    ...
                    prevEl: ".green-slider-button-prev"
                },
                on: {}
            });
        }
        if (document.querySelector(".clients-swiper")) new core(".clients-swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
